...
class CarNavigationNode(Node): 
    ...
    def setup_initial_pose(self): 
        ...
        initial_pose.pose.pose.position.x = 3719.699
        initial_pose.pose.pose.position.y = 73768.703
        initial_pose.pose.pose.orientation.z = -0.978
        initial_pose.pose.pose.orientation.w = 0.206
        time.sleep(10)
        self.initial_pose_publisher.publish(initial_pose) 
        
    def setup_goals(self): 
        self.goal_poses = [ 
        {'x': 3692.28, 'y': 73741.03, 'xx': 0.0, 'yy': 0.0, 'zz': -0.513, 'w': 0.858}, 
        {'x': 3720.472, 'y': 73686.75, 'xx': 0.0, 'yy': 0.0, 'zz': -0.510, 'w': 0.859},
        {'x': 3832.64, 'y': 73730.99, 'xx': 0.0, 'yy': 0.0, 'zz': 0.236, 'w': 0.971} 
        ]
        time.sleep(5) 
        self.publish_goal() 
